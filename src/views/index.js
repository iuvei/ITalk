...
export {default as ContactView} from './tabView/contacts'
export {default as PersonalStatusView} from './tabView/personalStatus'
export {default as NewsView} from './tabView/news'
